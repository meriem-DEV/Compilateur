...
public class Analyseur {
	...
	static FileNameExtensionFilter filter = new FileNameExtensionFilter("Fichiers text", " ");
...
/*********************************************************************************************************************/
	...
	public String UL_reserve(String chaine) {
		...
		String[] mot_reserve = {"Start_Program", "Int_Number",";;","Give","Real_Number",
                    "If","--", "<", "Else",  "Start", "Affect","to","Finish",     
				 "ShowMes",  "ShowVal", "//.",",",":", "End_Program","'" ,"ceci est un commentaire"};
		...
		String[] Affichage = {
                    ...
                    "Mot reserve pour condition","symbol inferieur","Mot reserve pour condition SINON",
                    "Debut d'un sous programme",
                    ...
                    "caractere reservé deux points", "Mot reserve Fin du programme","mot reservé simple cotes","example d'un commentaire"};
...
/*********************************************************************************************************************/
	...
	public String syntax(String chaine){
		...
		if(chaine.equals("Start_Program")) return "Début du programme";
                else if(chaine.equals("If -- i < j -- Give Aft_5 : 10 ;;")) return "condition et affectation d'une valeur à une variable";
		...
		else if(chaine.startsWith("//. ceci est un commentaire")) return "un commentaire";
		else if(chaine.equals("End_Program")) return "Fin du programme";
		else if(chaine.startsWith("ShowMes : ' ceci est un message ' ;;"))  return "Affichage d'un message à l'ecran";
                else if(chaine.startsWith("ShowVal : i ;;"))  return "Affichage d'une valeur à l'ecran";
                else if(chaine.startsWith("Int_Number : i , j , Aft_5 ;;"))  return "declaration des entiers";
                else if(chaine.startsWith("Real_Number : Aft34_2 ;;"))  return "declaration des reel";
                else if(chaine.startsWith("Give i : 23 ;;"))  return "affectation d'une valeur à une variable ";
                else if(chaine.startsWith("Affect i to  j ;;"))  return "declaration entre variables";
                else if(chaine.startsWith("Give Aft34_2 : 123.54 ;;"))  return "affectation d'une valeur à une variable";
				...
				if(mot[i].equals("Int_Number")){
					...
					if(id(mot[i]) != null)
						...
						if(mot[i].equals("to")){
                                                    ...
                                                    if(id(mot[i]) != null)
						i++;
                                                    if(mot[i].equals(";;")) return "affectation d'une variable à une variable"; 
							}
                                }
								}  
...
/*********************************************************************************************************************/
	...
	public String semantique(String chaine){
		if(chaine.equals("Start_Program")) return "public static void main(String[] args) {";
                else if(chaine.equals("Int_Number : i , j , Aft_5 ;;")) return "int:i,j,Aft_5;";
                else if(chaine.equals("Give i : 23 ;;")) return "i=23;";
                else if(chaine.equals("Real_Number : Aft34_2 ;;")) return "float:Aft34_2;";
                else if(chaine.equals("If -- i < j -- Give Aft_5 : 10 ;;")) return "if(i<j) Aft_5=10;";
		else if(chaine.equals("Else")) return "else";
		else if(chaine.equals("Start ")) return "{";
                 else if(chaine.equals("Affect i to  j ;;")) return "i=j;";
                  else if(chaine.equals("Give Aft34_2 : 123.54 ;;")) return "Aft34_2 = 123.54;";
		...
		else if(chaine.startsWith("ShowMes")&& chaine.endsWith(" : ' ceci est un message ' ;;")) return "System.out.println(\"ceci est un message\");";
                else if(chaine.startsWith("ShowVal") && chaine.endsWith(" : i ;;")) return "System.out.println(\"i\");";
		else if(chaine.contains(" ")) {
			mot = chaine.split(" ");
			int i=0;
